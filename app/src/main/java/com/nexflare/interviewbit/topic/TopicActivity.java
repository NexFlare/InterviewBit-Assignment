...
public class TopicActivity extends AppCompatActivity implements TopicMvpView {


    protected TopicMvpPresenter<TopicMvpView> mPresenter;
    ...
    protected ArrayList<TopicObject> arrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter.onAttach(TopicActivity.this);
    ...
    @Override
    public void showListOfItems(ArrayList<TopicObject> list) {

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(new TopicAdapter(this,list));
    ...
    public class FethchPracticeList extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            arrayList = crawler.getTopics(document);
